...
import Cs2TradeWindow from './components/Cs2TradeWindow.jsx';
import { withSettings } from './bootstrap.jsx';
import './styles.css';

const Cs2Wrapped = withSettings(Cs2TradeWindow);
...
class ErrorBoundary extends React.Component {
	...
	componentDidCatch(error, info) {
		console.error('Cs2TradeWindow crash:', error, info);
		this.setState({ info });
	}
		...
		if (this.state.error) {
			...
			return (
				<div className="inv-win-error cs2-crash">
					<b>Окно контрактов аварийно завершило работу.</b>
